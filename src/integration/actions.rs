...
use super::targets::{
    ...
    install_trae, uninstall_antigravity_cli, uninstall_claude, uninstall_codex, uninstall_copilot,
    ...
    uninstall_pi, uninstall_qodercli, uninstall_qwen, uninstall_trae,
};
